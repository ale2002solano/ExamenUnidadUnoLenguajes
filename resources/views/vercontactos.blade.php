                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-text">
                                    ...
                                    <input type="text" value="{{$directorios->codigoEntrada}}" class="form-control" readonly>
                                    <label for="">Nombre</label>
                                    <input type="text" value="{{$directorios->nombre}}" class="form-control" readonly>
                                    <label for="">Apellido</label>
                                    <input type="text" value="{{$directorios->apellido}}" class="form-control" readonly>
                                    <p>
